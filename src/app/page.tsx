    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="w-full h-[calc(100vh-64px)] bg-gradient-to-b from-slate-50 to-white flex flex-col items-center justify-center text-center px-4 relative">
        <motion.div
          ...
          className="max-w-4xl"
        >
          <h1 className="text-5xl md:text-7xl font-jost tracking-tight leading-tight md:leading-[1.1] text-gray-900 mb-8">
          <span className="text-[#003366]">{t.hero.titleLead} </span><span className="text-[#209BD0]">{t.hero.titleHighlight}</span>
          </h1>
